...
class Chest(PartialBlock):
    ...
    def get_block_model(self, block: Block, down: str, up: str, north: str, east: str, south: str, west: str, transparency: Tuple[bool, bool, bool, bool, bool, bool], modify_uv=True) -> BlockMesh:
        rotation = {
            ...
            4: 1,
            5: 3
        }.get(block.properties["facing_direction"].value, 0)

        return super().get_block_model(block, down, up, north, east, south, west, transparency, modify_uv=False).rotate(0, rotation)
